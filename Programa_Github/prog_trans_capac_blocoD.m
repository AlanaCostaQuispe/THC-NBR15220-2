...
BHL = [0.14, 0.19, 0.29];
ees = [1.0e-2, 2.0e-2, 1.0e-2]; % [e1, e2,  e]
...
Lvet = [0.027, 0.093, 0.02, 0.011, 0.02, 0.093, 0.027];

Bmat = zeros(7,5);
Bmat(1,1)   =  BHL(1);
Bmat(2,1:3)   = [ 0.027, 0.086, 0.027];
Bmat(3,1)   =  BHL(1);
Bmat(4,:) = [0.027, 0.033, 0.02, 0.033, 0.027];
Bmat(5,1)   =  BHL(1);
Bmat(6,1:3)   = [ 0.027, 0.086, 0.027];
Bmat(7,1)   =  BHL(1);
