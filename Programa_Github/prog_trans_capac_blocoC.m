...
Lvet = [0.025, 0.095, 0.02, 0.011, 0.02, 0.095, 0.025];

Bmat = zeros(7,5);
Bmat(1,1)   =  BHL(1);
Bmat(2,1:3)   = [ 0.025, 0.09, 0.025];
Bmat(3,1)   =  BHL(1);
Bmat(4,:) = [0.025, 0.035, 0.02, 0.035, 0.025];
Bmat(5,1)   =  BHL(1);
Bmat(6,1:3)   = [ 0.025, 0.09, 0.025];
Bmat(7,1)   =  BHL(1);
